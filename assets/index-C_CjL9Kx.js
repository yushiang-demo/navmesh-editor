 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(I,Y){var Q=I.length;I.push(Y);e:for(;0<Q;){var oe=Q-1>>>1,Me=I[oe];if(0<r(Me,Y))I[oe]=Y,I[Q]=Me,Q=oe;else break e}}function n(I){return I.length===0?null:I[0]}function i(I){if(I.length===0)return null;var Y=I[0],Q=I.pop();if(Q!==Y){I[0]=Q;e:for(var oe=0,Me=I.length,Ge=Me>>>1;oe<Ge;){var V=2*(oe+1)-1,ne=I[V],fe=V+1,ce=I[fe];if(0>r(ne,Q))fe<Me&&0>r(ce,ne)?(I[oe]=ce,I[fe]=Q,oe=fe):(I[oe]=ne,I[V]=Q,oe=V);else if(fe<Me&&0>r(ce,Q))I[oe]=ce,I[fe]=Q,oe=fe;else break e}}return Y}function r(I,Y){var Q=I.sortIndex-Y.sortIndex;return Q!==0?Q:I.id-Y.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],u=[],d=1,h=null,f=3,m=!1,v=!1,y=!1,p=typeof setTimeout=="function"?setTimeout:null,c=typeof clearTimeout=="function"?clearTimeout:null,g=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function _(I){for(var Y=n(u);Y!==null;){if(Y.callback===null)i(u);else if(Y.startTime<=I)i(u),Y.sortIndex=Y.expirationTime,e(l,Y);else break;Y=n(u)}}function M(I){if(y=!1,_(I),!v)if(n(l)!==null)v=!0,W(P);else{var Y=n(u);Y!==null&&K(M,Y.startTime-I)}}function P(I,Y){v=!1,y&&(y=!1,c(b),b=-1),m=!0;var Q=f;try{for(_(Y),h=n(l);h!==null&&(!(h.expirationTime>Y)||I&&!D());){var oe=h.callback;if(typeof oe=="function"){h.callback=null,f=h.priorityLevel;var Me=oe(h.expirationTime<=Y);Y=t.unstable_now(),typeof Me=="function"?h.callback=Me:h===n(l)&&i(l),_(Y)}else i(l);h=n(l)}if(h!==null)var Ge=!0;else{var V=n(u);V!==null&&K(M,V.startTime-Y),Ge=!1}return Ge}finally{h=null,f=Q,m=!1}}var A=!1,T=null,b=-1,w=5,S=-1;function D(){return!(t.unstable_now()-S<w)}function G(){if(T!==null){var I=t.unstable_now();S=I;var Y=!0;try{Y=T(!0,I)}finally{Y?H():(A=!1,T=null)}}else A=!1}var H;if(typeof g=="function")H=function(){g(G)};else if(typeof MessageChannel<"u"){var $=new MessageChannel,q=$.port2;$.port1.onmessage=G,H=function(){q.postMessage(null)}}else H=function(){p(G,0)};function W(I){T=I,A||(A=!0,H())}function K(I,Y){b=p(function(){I(t.unstable_now())},Y)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(I){I.callback=null},t.unstable_continueExecution=function(){v||m||(v=!0,W(P))},t.unstable_forceFrameRate=function(I){0>I||125<I?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):w=0<I?Math.floor(1e3/I):5},t.unstable_getCurrentPriorityLevel=function(){return f},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(I){switch(f){case 1:case 2:case 3:var Y=3;break;default:Y=f}var Q=f;f=Y;try{return I()}finally{f=Q}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(I,Y){switch(I){case 1:case 2:case 3:case 4:case 5:break;default:I=3}var Q=f;f=I;try{return Y()}finally{f=Q}},t.unstable_scheduleCallback=function(I,Y,Q){var oe=t.unstable_now();switch(typeof Q=="object"&&Q!==null?(Q=Q.delay,Q=typeof Q=="number"&&0<Q?oe+Q:oe):Q=oe,I){case 1:var Me=-1;break;case 2:Me=250;break;case 5:Me=1073741823;break;case 4:Me=1e4;break;default:Me=5e3}return Me=Q+Me,I={id:d++,callback:Y,priorityLevel:I,startTime:Q,expirationTime:Me,sortIndex:-1},Q>oe?(I.sortIndex=Q,e(u,I),n(l)===null&&I===n(u)&&(y?(c(b),b=-1):y=!0,K(M,Q-oe))):(I.sortIndex=Me,e(l,I),v||m||(v=!0,W(P))),I},t.unstable_shouldYield=D,t.unstable_wrapCallback=function(I){var Y=f;return function(){var Q=f;f=Y;try{return I.apply(this,arguments)}finally{f=Q}}}})(Rm);Am.exports=Rm;var Bv=Am.exports;/**
 * @license React
...
`)+`
`+c);const _=g+p+o,M=g+c+a,P=$p(r,r.VERTEX_SHADER,_),A=$p(r,r.FRAGMENT_SHADER,M);r.attachShader(y,P),r.attachShader(y,A),n.index0AttributeName!==void 0?r.bindAttribLocation(y,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(y,0,"position"),r.linkProgram(y);function T(D){if(t.debug.checkShaderErrors){const G=r.getProgramInfoLog(y).trim(),H=r.getShaderInfoLog(P).trim(),$=r.getShaderInfoLog(A).trim();let q=!0,W=!0;if(r.getProgramParameter(y,r.LINK_STATUS)===!1)if(q=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,y,P,A);else{const K=qp(r,P,"vertex"),I=qp(r,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(y,r.VALIDATE_STATUS)+`
...
`;class jA extends rn{constructor(){const e=new ti,n=new ei({vertexShader:XA,fragmentShader:YA});super(),this.geometry=e,this.material=n,this.position.set(0,.1,0),this.frustumCulled=!1}updateTrace(e){const{attributes:n}=e.reduce((i,r,s)=>{const{attributes:o,latestPoint:a}=i;if(!a)return{...i,latestPoint:r};const l=new Se(a.x,a.z),u=new Se(r.x,r.z),d=new Se().subVectors(u,l).normalize(),h=.5,f=new Se(-d.y,d.x).multiplyScalar(h/2),m=new Se().subVectors(u,l).length()/h,v=new Se().addVectors(l,f),y=[0,0],p=new Se().subVectors(l,f),c=[0,1],g=new Se().addVectors(u,f),_=s===e.length-1?Math.floor(m):m,M=[_,0],P=new Se().subVectors(u,f),A=[_,1];o.vertices.push(v.x,.1,v.y,p.x,.1,p.y,g.x,.1,g.y,P.x,.1,P.y);const T=new Ye().setHSL(l.length()/10,1,.5).toArray(),b=new Ye().setHSL(u.length()/10,1,.5).toArray();o.colors.push(...T,...T,...b,...b);const w=(s-1)*4;return o.indices.push(w+0,w+2,w+1,w+2,w+3,w+1),o.uvs.push(...y,...c,...M,...A),{latestPoint:r,attributes:o}},{latestPoint:void 0,attributes:{indices:[],vertices:[],uvs:[],colors:[]}});this.geometry.setIndex(n.indices),this.geometry.setAttribute("position",new Wt(new Float32Array(n.vertices),3)),this.geometry.setAttribute("uv",new Wt(new Float32Array(n.uvs),2)),this.geometry.setAttribute("color",new Wt(new Float32Array(n.colors),3))}}const $A=({wallConfig:t,walls:e})=>{const n=vt.useRef(new jA),{scene:i,renderer:r,camera:s,controls:o}=qo(),{navMesh:a,navMeshHelper:l}=dv({wallConfig:t,walls:e});return vt.useEffect(()=>{if(i)return i.add(n.current),()=>{i.remove(n.current)}},[i]),vt.useEffect(()=>{if(!r||!l||!a)return;const u=new eA(a),d=new h1;let h=null;const f=(c,g)=>{const _=new Se(c,g);d.setFromCamera(_,s);const P=d.intersectObjects([l])[0];return P?P.point:null},m=(c,g)=>{const{point:_}=u.findClosestPoint({x:c.x,y:c.y,z:c.z}),{point:M}=u.findClosestPoint({x:g.x,y:g.y,z:g.z});return u.computePath(_,M)},v=c=>{const g=f(c.clientX/window.innerWidth*2-1,-(c.clientY/window.innerHeight)*2+1);g&&(o.enabled=!1,h=g)},y=c=>{const g=f(c.clientX/window.innerWidth*2-1,-(c.clientY/window.innerHeight)*2+1);if(h&&g){const{path:_}=m(h,g);n.current.updateTrace(_)}},p=()=>{o.enabled=!0,h=null};return r.domElement.addEventListener("pointerdown",v),r.domElement.addEventListener("pointermove",y),r.domElement.addEventListener("pointerup",p),()=>{r.domElement.removeEventListener("pointerdown",v),r.domElement.removeEventListener("pointermove",y),r.domElement.removeEventListener("pointerup",p)}},[r,a]),null},qA=({wallConfig:t,walls:e})=>fi.jsxs(b1,{children:[fi.jsx(F1,{wallConfig:t,walls:e}),fi.jsx(WA,{wallConfig:t,walls:e}),fi.jsx($A,{wallConfig:t,walls:e})]}),fv={wallThickness:.4,width:20,length:20,wallHeight:1},KA=[[[1,-9.75],[1,1.2]],[[-4.6,1.2],[1.02,1.2]],[[-9.55,1.2],[-7.1,1.2]],[[4,-9.75],[4,-4]],[[4,-.6],[4,.75]],[[4,.55],[8.34,.55]],[[-9.65,8.5],[-6.8,8.5]],[[-3.75,8.5],[2.5,8.5]],[[5.55,8.5],[8.34,8.5]],[[-9.9,-9.75],[1.2,-9.75]],[[3.8,-9.75],[8.7,-9.75]],[[-9.7,-9.75],[-9.7,8.7]],[[8.5,-9.75],[8.5,8.7]]].map(([t,e])=>[[t[0],0,t[1]],[e[0],fv.wallHeight,e[1]]]),ZA=()=>fi.jsx(qA,{wallConfig:fv,walls:KA});A_(document.getElementById("root")).render(fi.jsx(vt.StrictMode,{children:fi.jsx(ZA,{})}));
